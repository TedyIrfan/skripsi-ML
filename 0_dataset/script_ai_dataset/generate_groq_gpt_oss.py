"""
Generate AI Text dari Groq API - GPT-OSS-120B
Target: 80 data (40 casual + 40 formal)
"""
...
def main():
    ...
    print("\n" + "="*60)
    print("GROQ GPT-OSS-120B TEXT GENERATOR")
    print(f"Model: {MODEL}")
    print(f"Target: 80 texts (40 casual + 40 formal)")
    ...
    if all_data:
        ...
        filename = f"data_ai_groq_gptoss_{len(all_data)}.csv"
